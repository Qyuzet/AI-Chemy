  ...
  return (
    <nav className="bg-black shadow-md w-full z-10 border-b border-white dark:bg-black dark:border-white">
      <div className="max-w-screen-xl mx-auto flex items-center justify-between p-4 md:px-6">
        ...
        <button
          type="button"
          className="md:hidden text-white focus:outline-none z-20 relative"
        ...
        <div className="hidden md:flex space-x-4">
          ...
          <button className="px-6 py-2 text-white bg-gradient-to-r from-blue-500 to-purple-600 hover:from-purple-600 hover:to-blue-500 transition duration-300 ease-in-out rounded-lg shadow-lg">
            Confirm Material
          </button>
        </div>
      </div>
      <div
        className={`${
          isOpen ? "block" : "hidden"
        } md:hidden bg-gray-900 p-4 space-y-3 text-center`}
      >
        <button className="w-full py-2 text-white bg-gradient-to-r from-purple-600 to-blue-500 hover:from-blue-500 hover:to-purple-600 transition duration-300 ease-in-out rounded-lg shadow-lg">
          Connect ICP
        </button>
        <button className="w-full py-2 text-white bg-gradient-to-r from-blue-500 to-purple-600 hover:from-purple-600 hover:to-blue-500 transition duration-300 ease-in-out rounded-lg shadow-lg">
          Confirm Material
        </button>
      </div>
    </nav>
